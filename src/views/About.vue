            ...
            <div class="h-100 bg-light d-flex align-items-center">
              <div class="py-5 px-4">
                ...
                <ul class="list-inline small text-uppercase mb-0">
                  ...
                  <li class="list-inline-item align-middle me-0"><a class="fw-bold reset-anchor" href="#!">Zanele Moni</a></li>
                  <li class="list-inline-item text-gray align-middle me-0">|</li>
                  <li class="list-inline-item text-gray align-middle">March, 2022</li>
                </ul>
              </div>
            </div>
          </div>
...
.about .image {
  /* background: url("https://i.picsum.photos/id/244/367/267.jpg?hmac=KjgMJx6F0HZVdOgZrxswmlXWZoaStH88a0Gw8HGXezI") center center no-repeat; */
